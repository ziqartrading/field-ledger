...
check(index.includes("versionAtLeast(r.backendVersion,'3.6.3')"), 'Required backend version is not aligned');
...
check(index.includes('activation-panel.js?v=363'), 'Activation panel cache-buster is stale');
